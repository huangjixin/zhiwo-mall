...
import com.zwo.modules.system.dao.TbOrgMapper;
...
public class OrgServiceImpl extends BaseService<TbOrg> implements ITbOrgService {
	private static Logger logger = LoggerFactory.getLogger(OrgServiceImpl.class);

	private static final String BASE_MESSAGE = "【TbOrgServiceImpl服务类提供的基础操作增删改查等】";
	...
	@Override
	public Mapper<TbOrg> getBaseMapper() {
		return orgMapper;
	}
	 ...
	 */
	/*
	 * @Override public int insertBatch(List<TbOrg> list) { // TODO
	 ...
	 */
	@Override
	@CacheEvict(value = "TbOrg", allEntries = true)
	public int deleteByExample(Object example) {
		...
		// 逻辑操作
		int result = orgMapper.deleteByExample(example);
...
//	@Override
	public int deleteBatch(List<String> list) {
		...
		// 逻辑操作
		TbOrgCriteria orgCriteria = new TbOrgCriteria();
		orgCriteria.createCriteria().andIdIn(list);
		int result = orgMapper.deleteByExample(orgCriteria);
	...
	public List<TbOrg> selectByExample(Object example) {
		return null;
	}
	...
	public TbOrg selectByPrimaryKey(String id) {
		...
		// 逻辑操作
		TbOrg org = super.selectByPrimaryKey(id);
		if (logger.isInfoEnabled())
	...
	@CacheEvict(value = "TbOrg", allEntries = true)
	@Override
	public int updateByExampleSelective(TbOrg record, Object example) {
		// 日志记录
		if (logger.isInfoEnabled())
	...
	@Override
	@CacheEvict(value = "TbOrg", allEntries = true)
	public int updateByExample(TbOrg record, Object example) {
		//日志记录
		if(logger.isInfoEnabled())
	 ...
	 */
	@Override
	@CacheEvict(value = "TbOrg", key="#record.id")
	public int updateByPrimaryKeySelective(TbOrg record) {
		// 日志记录
		if (logger.isInfoEnabled())
	...
	@Override
	@CacheEvict(value = "TbOrg", key="#record.id")
	public int updateByPrimaryKey(TbOrg record) {
		// 日志记录
		if (logger.isInfoEnabled())
	...
	@Transactional(readOnly = true)
	@Override
	public PageInfo<TbOrg> selectByPageInfo(Object example, PageInfo<TbOrg> pageInfo) {
		if (logger.isInfoEnabled())
	...
	public static void main(String[] args) {
		...
		ITbOrgService orgServiceImpl = (ITbOrgService) context.getBean("orgServiceImpl");
		TbOrg org = new TbOrg();
		org.setId(System.currentTimeMillis() + "");
		int result = orgServiceImpl.insertSelective(org);
		logger.info(result + "");
	}
