...
<div class="btn3 clearfix">
		<div class="menu" style="width: 15%; border-right:1px solid #ebebeb; background-color:#ffffff;">
			<div class="bt-name" style="color: red;">
				<i class="fa fa-home" aria-hidden="true"></i>&nbsp;
			</div>
		</div>
		<!--menu-->
		<div class="menu" style="width: 15%; border-right:1px solid #ebebeb; color:#58595B; background-color:#ffffff;">
			<div class="bt-name">
