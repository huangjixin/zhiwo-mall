 ...
 */
@Service
public class MindexUpdateMessageListener implements MessageListener {
	@Autowired
	@Lazy(true)
	...
	public void onMessage(final Message message, final byte[] pattern) {
		...
		if (body instanceof String) {
			...
			String templateName = "mindex.ftl";
			String fileName = webappRoot + File.separator + "mindex.htm";
	...
	public static void main(String[] args) {
		String path = MindexUpdateMessageListener.class.getResource("/")
				.getPath();
