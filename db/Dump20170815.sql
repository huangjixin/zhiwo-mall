...
CREATE TABLE `pr_product_package_price` (
  ...
  `PROPERTY_VAlUE_ID` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK_PACKAGE_PRICE_PRODUCT_idx` (`PRODUCT_ID`),
  KEY `FK_PACKAGE_PRICE_PROPERTY_idx` (`PROPERTY_ID`),
  KEY `FK_PACKAGE_PRICE_PROPERTY_VALUE_idx` (`PROPERTY_VAlUE_ID`),
  ...
  CONSTRAINT `FK_PACKAGE_PRICE_PROPERTY` FOREIGN KEY (`PROPERTY_ID`) REFERENCES `pr_product_property` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_PACKAGE_PRICE_PROPERTY_VALUE` FOREIGN KEY (`PROPERTY_VAlUE_ID`) REFERENCES `pr_product_property_value` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `pr_product_property_value` (
  ...
  CONSTRAINT `FK_PRO_VALUE_PRODUCT` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `pr_product` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `tb_role` (
  ...
  PRIMARY KEY (`ID`),
  KEY `SORTINDEX` (`SORT`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='角色组';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_user_assets` (
  ...
  PRIMARY KEY (`ID`),
  KEY `SORTINDEX` (`SORT`)
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8 COMMENT='用户附件';
/*!40101 SET character_set_client = @saved_cs_client */;
