...
public class MoneyUtil implements Serializable{
	...
	public static int yuan2Fen(String yuanStr){
		BigDecimal bd = new BigDecimal(yuanStr);
		return bd.multiply(new BigDecimal(100)).intValue();
	}
	public static String fen2Yuan(String fenStr){
		BigDecimal bd = new BigDecimal(fenStr);
   ...
   *
    ...
    * @Description: 元转分
    * @author xieyc
    * @date 2018年10月8日 上午11:04:04   
    *
    */
	public static int doubeToInt(double m){
	 ...
	 * @Description: 分转元
	 * @author xieyc
	 * @date 2018年10月8日 上午11:03:53   
	 *
	 */
	public static double IntToDouble(int m){
		BigDecimal bd = new BigDecimal(m);
		return bd.divide(new BigDecimal(100)).doubleValue();
	}
