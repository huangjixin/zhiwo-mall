...
public class BigDecimalUtil {
    ...
    public static final String DECIMAL_DEFAULT="0.00";

    public static final DecimalFormat DECIMAL_FORMAT_DEFAULT = new DecimalFormat("0.00");

    public static final BigDecimal BIG_DECIMAL_DEFAULT = new BigDecimal("0.00");
    ...
    public static BigDecimal objectFormatToBD(Object o,String format) {
        ...
        DecimalFormat decimalFormat = new DecimalFormat(format);
        return BigDecimalUtil.objectToBigDecimal(
                decimalFormat.format(
                        BigDecimal.valueOf(Double.valueOf(String.valueOf(o)))));
    }

//    public static void main(String[] args) {
//        List<BigDecimal> bigDecimals = new ArrayList<>(3);
...
//        bigDecimals.add(new BigDecimal(2));
//        bigDecimals.size();
//        BigDecimal bigDecimal = BigDecimalUtil.arrTotalToBD(bigDecimals);
