...
import com.zwo.modules.core.vo.OSSClientConstants;
...
public class AliyunOSSClientUtil {
	...
	public static final String accessKeyId = "LTAIp2FTTphzWyCM";
	public static final String accessKeySecret = "x5jyKIA2yih5DfG2HIKyGquqgWrHoO";
	public static final String bucketName = "bhms-fru-dev";

	private static final String PROTOCOL = "http://";
	private static final String ENDPOINTURI = "oss-cn-shenzhen.aliyuncs.com";
	// //log日志
...
//		// 上传文件
//		String files = "D:\\WeChat\\ceshi.png";
...
//		URL url = ossClient.generatePresignedUrl(BACKET_NAME, md5key, expiration, HttpMethod.GET);
//		logger.info(url.toString());
//		String u = PROTOCOL + BACKET_NAME + "." + ENDPOINTURI + "/" + FOLDER + "/" + filess.getName();
//		logger.info(u);
//	}
}
