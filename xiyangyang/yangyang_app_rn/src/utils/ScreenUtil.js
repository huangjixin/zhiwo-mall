...
//转换成日期
export const toDate = (timestamp, format1 = 'yyyy-MM-dd hh:mm:ss')=> {
    try {
        if (timestamp > 10000) {
            let date = new Date();
 ...
 * @param errorCallback
 */
export const saveAsyncStorage = (key, value, successCallback, errorCallback)=> {
 ...
 * @param errorCallback
 */
export const getAsyncStorage = (key, successCallback, errorCallback) =>{
...
export default {
    isIphoneX,setSpText2,getAsyncStorage,saveAsyncStorage,removeAsyncStorage,toTimestamp,toDate,isEmpty,scaleSize
};
//
// // 将当前时间换成时间格式字符串
