...
<body>
	<div id="toolbar">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
		<label>名称：</label>&nbsp;<input id="membernameInput" class="input" style="width:100px;"/>&nbsp;
		<%@ include file="/WEB-INF/include/easyui-queryButton.jsp"%>
		<!-- <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
			onclick="create('member')">新增</a> <a href="#" class="easyui-linkbutton"
	...
	<table id="tgrid" 
		...
		<thead>
			<tr>
				...
				<th data-options="field:'membername',align:'center'">名称</th>
...
//				%>
				btn += '<a href="#" class="easyui-linkbutton button-red"  onclick="deleteById(\'tgrid\',\''
					+ rec.id + '\',\'member\')"><i class="icon-trash"></i>&nbsp;&nbsp;删除 </a>';
					btn += "&nbsp;&nbsp;";
					btn += ''
//				<%
//				}
...
//				%> 
				btn += '<a href="#" class="easyui-linkbutton button-green"  onclick="update(\''
					+ rec.id + '\',\'member\')"><i class="icon-edit"></i>&nbsp;&nbsp;编辑 </a>';
//				 <%
//				}
//							%> 
