...
<body>
	<div id="toolbar">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
		<label>名称：</label>&nbsp;<input id="guessCategorynameInput" class="input" style="width:100px;"/>&nbsp;
		<%@ include file="/WEB-INF/include/easyui-queryButton.jsp"%>
		<!-- <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
			onclick="create('guessCategory')">新增</a> <a href="#" class="easyui-linkbutton"
...
//				%>
				btn += '<a href="#" class="easyui-linkbutton button-red"  onclick="deleteById(\'tgrid\',\''
					+ rec.id + '\',\'guessCategory\')"><i class="icon-trash"></i>&nbsp;&nbsp;删除 </a>';
					btn += "&nbsp;&nbsp;";
					btn += ''
//				<%
//				}
//			%>
//			<%
//				if(SecurityUtils.getSubject()!=null&&SecurityUtils.getSubject().isPermitted("system:guessCategory:edit")){
//				%> 
				btn += '<a href="#" class="easyui-linkbutton button-green"  onclick="update(\''
					+ rec.id + '\',\'guessCategory\')"><i class="icon-edit"></i>&nbsp;&nbsp;编辑 </a>';
//				 <%
//				}
//							%> 
