...
import com.zwo.modules.member.dao.MemberLevelMapper;
import com.zwo.modules.member.domain.MemberLevel;
import com.zwo.modules.member.domain.MemberLevelCriteria;
import com.zwo.modules.member.service.IMemberLevelService;
...
public class MemberLevelServiceImpl extends BaseService<MemberLevel> implements IMemberLevelService {
	private static Logger logger = LoggerFactory.getLogger(MemberLevelServiceImpl.class);

	private static final String BASE_MESSAGE = "【MemberLevelServiceImpl服务类提供的基础操作增删改查等】";
	...
	@Override
	public Mapper<MemberLevel> getBaseMapper() {
	 ...
	 */
	/*
	 * @Override public int insertBatch(List<MemberLevel> list) { // TODO
	 ...
	 */
	@Override
	@CacheEvict(value = "MemberLevel", allEntries = true)
	public int deleteByExample(Object example) {
		...
		// 逻辑操作
		int result = memberLevelMapper.deleteByExample(example);
	...
	public int deleteBatch(List<String> list) {
		...
		// 逻辑操作
		MemberLevelCriteria memberLevelCriteria = new MemberLevelCriteria();
		memberLevelCriteria.createCriteria().andIdIn(list);
		int result = memberLevelMapper.deleteByExample(memberLevelCriteria);
	...
	public List<MemberLevel> selectByExample(Object example) {
	...
	public MemberLevel selectByPrimaryKey(String id) {
		...
		// 逻辑操作
		MemberLevel memberLevel = super.selectByPrimaryKey(id);
		if (logger.isInfoEnabled())
	...
	@CacheEvict(value = "MemberLevel", allEntries = true)
	@Override
	public int updateByExampleSelective(MemberLevel record, Object example) {
		// 日志记录
		if (logger.isInfoEnabled())
	...
	@Override
	@CacheEvict(value = "MemberLevel", allEntries = true)
	public int updateByExample(MemberLevel record, Object example) {
		// 日志记录
		if (logger.isInfoEnabled())
	 ...
	 */
	@Override
	@CacheEvict(value = "MemberLevel", key = "#record.id")
	...
	@Transactional(readOnly = true)
	@Override
	public PageInfo<MemberLevel> selectByPageInfo(Object example, PageInfo<MemberLevel> pageInfo) {
		if (logger.isInfoEnabled())
	...
	public static void main(String[] args) {
		...
		IMemberLevelService memberLevelServiceImpl = (IMemberLevelService) context.getBean("memberLevelServiceImpl");
		MemberLevel memberLevel = new MemberLevel();
		memberLevel.setId(System.currentTimeMillis() + "");
		int result = memberLevelServiceImpl.insertSelective(memberLevel);
		logger.info(result + "");
	}
