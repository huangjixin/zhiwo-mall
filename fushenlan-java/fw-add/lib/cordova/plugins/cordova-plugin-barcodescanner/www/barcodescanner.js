 ...
 */
    ...
    var ScannerLoader = function (require, exports, module) {
        ...
        BarcodeScanner.prototype.generateBitmap = function (successCallback, errorCallback,options) {
            if (errorCallback == null) {
                errorCallback = function () {
                };
            }
            ...
            options.addLogo = options.addLogo || "";

            exec(successCallback, errorCallback, 'BarcodeScanner', 'generateBitmap', [options]);
        };
