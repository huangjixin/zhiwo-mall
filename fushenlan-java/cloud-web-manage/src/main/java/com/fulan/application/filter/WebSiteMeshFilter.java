...
public class WebSiteMeshFilter extends ConfigurableSiteMeshFilter {
    ...
    String[][] urls = new String[][]{
    	{	
    		...
    		"/manage/studyPlanManage/offlineCourse_add",
    		"/manage/sms/selectFailUserById",
    		"/manage/classPlan/choosePerson",
    		"/manage/offlineManage/choosePerson",
    		"/manage/question/addQuestionOther",
    		"/manage/paper/paperQuestionPreview",
    		"/manage/group/listUsers",
    		"/manage/isSticky",
    		"/manage/erecruitment/getdmsinfo",
    		//"/WEB-INF/jsp/personnel/choice_dmsinfo.jsp",
    		"/manage/ceateMaterialForCourse"
