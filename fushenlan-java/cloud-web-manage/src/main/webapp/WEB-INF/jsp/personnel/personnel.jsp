...
<script>
        $(function(){
	       var keyWord = '${keyWord}';
	       pageAjax("${ctx}/manage/personnel/listByPageAjax?keyWord="+keyWord,'${page.pageSize}','${page.pageNo}','${page.pageTotal}','pageDiv');
        });
        ...
        function pageNext(url){
        	...
        	$.get(url,function(returnData){
        		if(returnData.code == '1'){
        			...
        			pageAjax("${ctx}/manage/personnel/listByPageAjax?keyWord="+keyWord,returnData.data.pageSize,returnData.data.pageNo,returnData.data.pageTotal,'pageDiv');
        		}
        	})
        }  
