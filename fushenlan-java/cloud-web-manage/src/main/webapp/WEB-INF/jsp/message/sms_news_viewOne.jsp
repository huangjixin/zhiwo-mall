...
#u1314 {
    ...
    height: 92px;
		...
		<input type="hidden" name="id" value="${smsTemplate.id}">
			<div class="title"><strong>消息详情</strong></div>
			<ul class="clearfix form_learn">
				...
				<li class="col-md-12"><strong style="font-size: 17px;">发送时间：</strong><span style="font-size: 17px;"><fmt:formatDate value="${smsNewsResultVO.sendTime}" pattern="yyyy-MM-dd"/></span></li>
			...
			<li class="col-md-12"><strong style="font-size: 17px;">发送对象：</strong>
			<c:forEach items="${smsNewsResultVO.smsNewsInfos}" var="smsNewsInfos" varStatus="ext">
			<span style="font-size: 17px;">${smsNewsInfos.phone }</span>
