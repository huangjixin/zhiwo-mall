...
<div class="wrapper wrap-login">
	<div class="login-box">
	  <form action="${ctx}/loginAccount" method="post" id="loginForm">
		...
		<ul>
			...
			<li class="login-btn">
				<button type="button" id="dl" class="btn btn-submit" onclick="loginSubmit();">登 录</button>
			</li>
		</ul>
		</form>
	</div>
...
<script src="${ctx}/resources/js/common/md5.js"></script>
