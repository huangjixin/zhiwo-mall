		...
		<div class="title"><strong>新增考题</strong></div>
			...
			<input type="hidden" name="question_type"  id="unitermingQuestion_type" value="0">
				<ul class="clearfix form_learn">
					<li class="col-md-12"><strong><ins>*</ins>题目内容：</strong><input type="text" id="unitermingContent" maxlength="50" class="ipt-text" value=""></li>
					<li class="col-md-4">
						<strong><ins>*</ins>题目类型：</strong>
						<div class="ipt-select" style="height:38px;border:1px solid #ddd;">
							<i class="icon-arrow-down"></i>
							<select id="unitermingTagId" style="position:relative;opacity:1;padding-left:10px;">
			...
			<input type="hidden" name="question_type"  id="MultiSelectQuestion_type" value="1">
				<ul class="clearfix form_learn">
					<li class="col-md-12"><strong><ins>*</ins>题目内容：</strong><input type="text" maxlength="50" id="MultiSelectContent" class="ipt-text" value=""></li>
					<li class="col-md-4">
						<strong><ins>*</ins>题目类型：</strong>
						<div class="ipt-select" style="height:38px;border:1px solid #ddd;">
							<i class="icon-arrow-down"></i>
							<select id="MultiSelectTagId" style="position:relative;opacity:1;padding-left:10px;">
								<option value="0">视频</option>
								<option value="1">PPT</option>
								<option value="2" >SCORM</option>
								<option value="3">WOED</option>
			...
			<input type="hidden" name="question_type"  id="judgeQuestion_type" value="2">
				<ul class="clearfix form_learn">
					<li class="col-md-12"><strong><ins>*</ins>题目内容：</strong><input type="text" maxlength="50" id="judgeContent" class="ipt-text" value=""></li>
					<li class="col-md-4">
						<strong><ins>*</ins>题目类型：</strong>
						<div class="ipt-select" style="height:38px;border:1px solid #ddd;">
							<i class="icon-arrow-down"></i>
							<select id="judgeTagId" style="position:relative;opacity:1;padding-left:10px;">
								<option value="0">视频</option>
								<option value="1">PPT</option>
								<option value="2" >SCORM</option>
								<option value="3">WOED</option>
			...
			<input type="hidden" name="question_type"  id="AskQuestion_type" value="3">
				<ul class="clearfix form_learn">
					<li class="col-md-12"><strong><ins>*</ins>题目内容：</strong><input type="text" maxlength="50" id="AskContent" class="ipt-text" value=""></li>
					<li class="col-md-4">
						<strong><ins>*</ins>题目类型：</strong>
						<div class="ipt-select" style="height:38px;border:1px solid #ddd;">
							<i class="icon-arrow-down"></i>
							<select id="AskTagId" style="position:relative;opacity:1;padding-left:10px;">
								<option value="0">视频</option>
								<option value="1">PPT</option>
								<option value="2" >SCORM</option>
								<option value="3">WOED</option>
