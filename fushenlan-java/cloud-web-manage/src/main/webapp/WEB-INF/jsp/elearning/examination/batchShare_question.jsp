		...
		<div class="form-detail">
			...
			<ul class="clearfix">
				...
				<c:forEach items="${questions }" var="question"  varStatus="status">
					<li class="col-md-6"><strong>资料名称：</strong>${question.content }</li>
			...
			<div class="ui-button">
				<button type="button" class="btn btn-submit" onclick="saveBatchQuestion()">保存</button>
