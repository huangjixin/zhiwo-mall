    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                var lcalendar_reset = _self.gearDate.querySelector(".lcalendar_reset");
                lcalendar_reset.addEventListener('touchstart', resetMobileCalendar);
            ...
            //清空
            function resetMobileCalendar(e) {
                e.preventDefault();
                var evt;
                try {
                    evt = new CustomEvent('input');
