...
!function (e, t) {
    ...
    return function (e) {
        ...
        o(7);
        var f = o(11), p = i(f), h = o(12), b = i(h), g = o(13), m = i(g), y = o(14), _ = i(y), w = o(15), x = i(w),
                ...
                return r(e, [{
                        ...
                        v["default"].bind(t, "touchstart", function (t) {
                            ...
                            if (o.touches.length > 0) {
                                var n = o.touches[0].pageX - e.switchPos.startX,
                                    i = o.touches[0].pageY - e.switchPos.startY, a = e.switchPos.x - n,
                                    r = e.switchPos.y - i;
                    ...
                    key: "_initPlugin", value: function (e) {
                        ...
                        e.vConsole = this, e.trigger("init"), e.trigger("renderTab", function (o) {
                            ...
                            if (o)for (var n = v["default"].one(".vc-topbar", t.$dom), i = function (t) {
                            ...
                            if (o)for (var n = v["default"].one(".vc-tool-last", t.$dom), i = function (t) {
                                var i = o[t],
                    ...
                    key: "removePlugin", value: function (e) {
                        ...
                        if (t.trigger("remove"), this.isInited) {
                            ...
                            for (var n = v["default"].all(".vc-topbar-" + e, this.$dom),
                                     i = 0; i < n.length; i++)n[i].parentNode.removeChild(n[i]);
                            var a = v["default"].one("#__vc_log_" + e);
                            a && a.parentNode.removeChild(a);
                            for (var r = v["default"].all(".vc-tool-" + e, this.$dom),
                                     l = 0; l < r.length; l++)r[l].parentNode.removeChild(r[l])
                        }
                    ...
                    key: "destroy", value: function () {
                        if (this.isInited) {
                            for (var e = Object.keys(this.pluginList),
                                     t = e.length - 1; t >= 0; t--)this.removePlugin(e[t]);
        ...
        function b(e) {
            var t = arguments.length <= 1 || void 0 === arguments[1] ? "	" : arguments[1],
                ...
                n = [], i = JSON.stringify(e, function (e, t) {
        ...
        l.one = function (e, t) {
            ...
            e && e.addEventListener(t, function (t) {
                var i = l.all(o, e);
                if (i)e:for (var a = 0; a < i.length; a++)for (var r = t.target; r;) {
                    if (r == i[a]) {
                        n.call(r, t);
                        break e
                    }
        ...
        var c = function () {
            ...
            }, d = o(5), u = i(d), v = o(4), f = n(v), p = o(17), h = i(p), b = o(22), g = i(b), m = o(23), y = i(m),
            _ = function (e) {
                function t() {
                    var e;
                    a(this, t);
        ...
        var c = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            }(), d = o(4), u = i(d), v = o(5), f = n(v), p = o(18), h = n(p), b = o(19), g = n(b), m = o(20), y = n(m),
            _ = o(21), w = n(_), x = 1e3, k = function (e) {
                ...
                return l(t, e), s(t, [{
                    ...
                    key: "onAddTopBar", value: function (e) {
                        for (var t = this, o = ["All", "Log", "Info", "Warn", "Error"], n = [],
                                 i = 0; i < o.length; i++)n.push({
                            name: o[i],
            ...
            return l(t, e), c(t, [{
                ...
                key: "printSystemInfo", value: function () {
                    var e = navigator.userAgent, t = "", o = e.match(/(ipod).*\s([\d_]+)/i),
                        n = e.match(/(ipad).*\s([\d_]+)/i), i = e.match(/(iphone)\sos\s([\d_]+)/i),
        ...
        var c = function () {
            ...
            }(), s = o(5), d = i(s), u = o(4), v = n(u), f = o(18), p = i(f), h = o(27), b = i(h), g = o(28), m = i(g),
                    ...
                    key: "mockAjax", value: function () {
                        ...
                        if (e) {
                            ...
                            t._open = o, t._send = n, window.XMLHttpRequest.prototype.open = function () {
                                var e = this, n = [].slice.call(arguments), i = n[0], a = n[1], r = t.getUniqueID(),
                                    l = null;
        ...
        o(31);
        var s = o(18), d = i(s), u = o(33), v = i(u), f = o(34), p = i(f), h = o(4), b = (n(h), o(5)), g = i(b),
            m = function (e) {
                function t() {
                    var e;
                    a(this, t);
        ...
        var s = function () {
        ...
        }(), d = o(35), u = i(d), v = o(36), f = i(v), p = o(4), h = (n(p), o(5)), b = i(h), g = function () {
            function e(t) {
            ...
            return s(e, [{
                ...
                key: "_createElementNode", value: function (e, t) {
                    ...
                    var i = b["default"].render(u["default"], {node: e}),
                        a = b["default"].render(f["default"], {node: e});
                    if (n) b["default"].addClass(t, "vcelm-noc"), t.appendChild(i), o || t.appendChild(a); else {
                        t.appendChild(i);
        ...
        var c = function () {
            ...
            }(), s = o(18), d = i(s), u = o(38), v = i(u), f = o(39), p = i(f), h = o(4), b = n(h), g = o(5), m = i(g),
            y = function (e) {
                function t() {
                    var e;
                    a(this, t);
                ...
                return l(t, e), c(t, [{
                    ...
                    key: "getCookieList", value: function () {
                        ...
                        for (var e = [], t = document.cookie.split(";"), o = 0; o < t.length; o++) {
                            var n = t[o].split("="), i = n[0].replace(/^ /, ""), a = n[1];
                    ...
                    key: "clearCookieList", value: function () {
                        if (document.cookie && navigator.cookieEnabled) {
                            for (var e = this.getCookieList(),
                                     t = 0; t < e.length; t++)document.cookie = e[t].name + "=;expires=Thu, 01 Jan 1970 00:00:00 GMT";
                            this.renderStorage()
                        }
                    }
                }, {
