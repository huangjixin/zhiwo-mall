...
ImagePicker.prototype.preview = function (success, fail, options) {
 			    options = options || {};

 			    options.currentItem = options.currentItem || 0;
 			    options.photos = options.photos ||[];

 			    return cordova.exec(success, fail, "ImagePicker", "preview", [options]);
}
