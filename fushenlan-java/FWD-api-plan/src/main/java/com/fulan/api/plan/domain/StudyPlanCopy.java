...
public class StudyPlanCopy implements Serializable {
	...
	private List<PlanCourseVoQ> planCourseVoQs;

	private Set<Long> planCourseIds;
	...
	public Set<Long> getPlanCourseIds() {
		return planCourseIds;
	}

	public void setPlanCourseIds(Set<Long> planCourseIds) {
