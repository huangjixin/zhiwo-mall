...
public class CmsChannelServiceImpl extends BaseService<CmsChannel> implements ICmsChannelService {
	private static Logger logger = LoggerFactory.getLogger(CmsChannelServiceImpl.class);
	 ...
	 */
	/*
	 * @Override public int insertBatch(List<CmsChannel> list) { // TODO
...
//	@CachePut(value = "CmsChannel", key = "#record.id")
	...
	public List<CmsChannel> selectByExample(Object example) {
	...
	public CmsChannel selectByPrimaryKey(String id) {
		...
		// 逻辑操作
		CmsChannel cmsChannel = super.selectByPrimaryKey(id);
		if (logger.isInfoEnabled())
	...
	@Transactional(readOnly = true)
	@Override
	public PageInfo<CmsChannel> selectByPageInfo(Object example, PageInfo<CmsChannel> pageInfo) {
		if (logger.isInfoEnabled())
	...
	public static void main(String[] args) {
		...
		ICmsChannelService cmsChannelServiceImpl = (ICmsChannelService) context.getBean("cmsChannelServiceImpl");
		CmsChannel cmsChannel = new CmsChannel();
		cmsChannel.setId(System.currentTimeMillis() + "");
		int result = cmsChannelServiceImpl.insertSelective(cmsChannel);
		logger.info(result + "");
	}
