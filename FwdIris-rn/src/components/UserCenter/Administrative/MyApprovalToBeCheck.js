...
var myApprovalToBeCheckListCache = [];
var modelItemCache = new Set([]);
export class MyApprovalToBeCheck extends React.Component {
    constructor(props){
        ...
        this.state = {
            ...
            myApprovalToBeCheckStart:0,
            myApprovalToBeCheckSize:10,
            myApprovalToBeCheckList:[],
        }
    }
    componentWillMount() {
        if(myApprovalToBeCheckListCache.length==0){
            this.fetchData(1,false);
        }else {
            this.setState({
                myApprovalToBeCheckList:myApprovalToBeCheckListCache
            });
        }
    }
    componentWillUnmount(){
        myApprovalToBeCheckListCache = this.state.myApprovalToBeCheckList;
...
//时间转换
        ...
        return (
            <View style={{height:ScreenHeight-140,}}>
                ...
                <FlatList
                    ...
                    data={this.state.myApprovalToBeCheckList}
                ...
                />
                {/*<TouchableWithoutFeedback onPress={this.administrativeToOaApplyFormDetail.bind(this,{type:1,status:0,baseStatus:1,})}>
                        <View style={{marginTop:15,backgroundColor:'#FFFFFF',marginLeft:20,marginRight:20,borderRadius:10,paddingBottom:20,paddingTop:10,}}>
                        ...
                        <TouchableWithoutFeedback onPress={this.administrativeToOaApplyFormDetail.bind(this,{type:2,status:0,baseStatus:1,})}>
                        <View style={{marginTop:15,backgroundColor:'#FFFFFF',marginLeft:20,marginRight:20,borderRadius:10,paddingBottom:20,paddingTop:10,}}>
                            <View style={{alignItems:'center',paddingBottom:10,flexDirection: 'row',borderBottomWidth:0.5,borderBottomStyle:'sold',borderBottomColor:'#CCCCCC',marginLeft:15,marginRight:15,}}>
                        ...
                        <View style={{marginTop:15,backgroundColor:'#FFFFFF',marginLeft:20,marginRight:20,borderRadius:10,paddingBottom:20,paddingTop:10,}}>
                            <View style={{alignItems:'center',paddingBottom:10,flexDirection: 'row',borderBottomWidth:0.5,borderBottomStyle:'sold',borderBottomColor:'#CCCCCC',marginLeft:15,marginRight:15,}}>
                                <Image style={{width:35, height:35,marginRight:10,}} source={require('../../../img/UserCenter/Promotion.png')} />
                                <Text style={{fontSize:18,flex:7,color:'#0D0D0D',}}>晋级申请</Text>
                                <Text style={{fontSize:18,flex:3,textAlign:'right',color:'#EC8C44',fontWeight:'bold'}}>待签约</Text>
                            </View>
                            <View style={{paddingTop:10,marginBottom:10,flexDirection: 'row',marginLeft:15,marginRight:15,}}>
                                <Text style={{fontSize:15,flex:7,}}>当前职级：LA</Text>
                                <Text style={{fontSize:15,flex:3,textAlign:'right',}}>05/12</Text>
    ...
    _onEndReached(){
        ...
        //     pageNo++;
        // }
        if(!this.state.myApprovalToBeCheckAllLoaded){
            pageNo++;
